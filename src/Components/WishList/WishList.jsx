...
import { removeFromWishList } from '../../utility/removeFromDB';

const WishList = ({singleWishData, setWishListData}) => {
    const { bookId, bookName, author, image, rating, category, tags,
        totalPages, yearOfPublishing, publisher, } = singleWishData;
    return (
        <div className="card lg:card-side bg-base-100 shadow-sm mb-9">
                    ...
                    <div className="card-body">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <button onClick={() => removeFromWishList(bookId, setWishListData)} className="btn btn-primary rounded-2xl p-4.5">Remove from Wishlist</button>
                        </div>
